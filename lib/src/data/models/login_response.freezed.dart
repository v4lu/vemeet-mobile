...
mixin _$LoginResponse {
  ...
  double get refreshTokenExpiry => throw _privateConstructorUsedError;
...
class _$LoginResponseImpl implements _LoginResponse {
  ...
  @override
  final double refreshTokenExpiry;
  @override
  final String cognitoId;

  @override
  String toString() {
    return 'LoginResponse(accessToken: $accessToken, accessTokenExpiry: $accessTokenExpiry, refreshToken: $refreshToken, refreshTokenExpiry: $refreshTokenExpiry, cognitoId: $cognitoId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, accessToken, accessTokenExpiry,
      refreshToken, refreshTokenExpiry, cognitoId);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final double accessTokenExpiry,
      required final String refreshToken,
      required final double refreshTokenExpiry,
      required final String cognitoId}) = _$LoginResponseImpl;
